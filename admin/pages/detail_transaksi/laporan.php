...
<a href="" class="btn btn-danger ms-2" name="reset">Reset</a>
</div>
</form>
<?php 
	$nt = $_POST['nt'];
...
<div class="card mt-4 mb-5">
  ...
  <tr>
  	...
  	<td colspan="6"><h6 class="text-end"> <?= rupiah($total_pendapatan);?></h6></td>
  </tr>
